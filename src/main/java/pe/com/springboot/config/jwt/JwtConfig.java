...
import pe.com.springboot.util.JksProperties;
...
public class JwtConfig {
	...
	public KeyStore keyStore() {
		try {
			...
			InputStream resourceAsStream = Thread.currentThread().getContextClassLoader()
					.getResourceAsStream(this.jksProperties.keystorePath());
	...
	public RSAPrivateKey jwtSigningKey(KeyStore keyStore) {
		try {
			Key key = keyStore.getKey(this.jksProperties.keystoreKeyAlias(),
					this.jksProperties.keystorePrivateKeyPassphrase().toCharArray());
